...
int main(int argc, char **argv) {
  ...
  InterpolationWalk<float> interpolation_walk_original(
      odata.data(), N, global_dimensions.data());
  ...
  SZ::writefile("oerror.dat", interp_errors_orig.data(),
                interp_errors_orig.size());
  SZ::writefile("derror.dat", interp_errors_decompressed.data(),
                interp_errors_decompressed.size());
